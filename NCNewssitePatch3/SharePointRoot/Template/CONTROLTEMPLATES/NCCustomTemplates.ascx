    ...
    <Template>
        <span id="nc-articleeditform">
            ...
            <table class="ms-formtable" style="margin-top: 8px;" border="0" cellpadding="0" cellspacing="0"
                ...
                <tr id="nc-articleeditform-managedkeywords">
                    <SharePoint:CompositeField ID="ManagedKeywords" runat="server" FieldName="TaxKeyword" />
                </tr>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                $("#nc-articleeditform-managedkeywords > td > H3").text('Managed keywords');
            });
