...
{
    public class NCNewssitePatch1AddDefaultPagesViewReceiver : SPFeatureReceiver
    {
        public override void FeatureActivated(SPFeatureReceiverProperties properties)
        {
            ...
            viewfields.Add("Parent_x0020_page");
            viewfields.Add("Sort_x0020_order");
            viewfields.Add("Modified");
            viewfields.Add("Editor");
            viewfields.Add("CheckoutUser");
            ...
            collection.Add("DefaultView", viewfields, query, 5000, true, true);
            web.Update();
